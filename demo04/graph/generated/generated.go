...
func (ec *executionContext) _Query_persons(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPerson2ᚕᚖlaiᚗcomᚋgqlgen_studyᚋdemo04ᚋgraphᚋmodelᚐPersonᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_student(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Student(rctx, args["id"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalOStudent2ᚖlaiᚗcomᚋgqlgen_studyᚋdemo04ᚋgraphᚋmodelᚐStudent(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNPerson2ᚕᚖlaiᚗcomᚋgqlgen_studyᚋdemo04ᚋgraphᚋmodelᚐPersonᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Person) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPerson2ᚖlaiᚗcomᚋgqlgen_studyᚋdemo04ᚋgraphᚋmodelᚐPerson(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNPerson2ᚖlaiᚗcomᚋgqlgen_studyᚋdemo04ᚋgraphᚋmodelᚐPerson(ctx context.Context, sel ast.SelectionSet, v *model.Person) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOStudent2ᚖlaiᚗcomᚋgqlgen_studyᚋdemo04ᚋgraphᚋmodelᚐStudent(ctx context.Context, sel ast.SelectionSet, v *model.Student) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
